...
from gourmet.adapter.inbound.api.schemas.catalog_schemas import (
    FoodCategoryItem,
...
from gourmet.app.use_cases.category_catalog_interactor import list_food_categories
from gourmet.app.use_cases.nearby_restaurants_interactor import list_nearby_restaurants
from gourmet.app.use_cases.restaurant_enrichment_interactor import get_restaurant_enrichment
from gourmet.app.use_cases.restaurant_menu_interactor import get_restaurant_menus
from gourmet.app.use_cases.restaurant_location_interactor import parse_user_location
from gourmet.app.use_cases.search_suggest_interactor import suggest_search
from gourmet.app.use_cases.topic_restaurants_interactor import get_topic_restaurants
...
def read_restaurant_enrichment(
    ...
    if payload is None:
        raise HTTPException(status_code=404, detail="식당을 찾을 수 없습니다.")
    from gourmet.adapter.inbound.api.schemas.catalog_schemas import EnrichmentSourceStatus
