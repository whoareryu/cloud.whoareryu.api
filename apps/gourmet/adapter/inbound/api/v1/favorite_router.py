...
from gourmet.adapter.inbound.api.schemas.favorite_schema import (
    FavoriteCardItem,
    FavoriteCheckResponse,
    FavoriteToggleRequest,
    FavoriteToggleResponse,
)
from gourmet.app.dtos.favorite_dto import FavoriteCheckQuery, FavoriteToggleCommand
from gourmet.app.ports.input.favorite_use_case import FavoriteUseCase
from gourmet.dependencies.favorite import get_favorite_use_case
