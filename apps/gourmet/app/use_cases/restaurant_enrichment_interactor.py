...
from gourmet.adapter.outbound.http.kakao_local_client import lookup_place as kakao_lookup
from gourmet.adapter.outbound.http.localdata_client import lookup_store as localdata_lookup
from gourmet.config.external_settings import get_external_settings
