...
from gourmet.data.ingestion.category_normalizer import (
    NON_MEAL_CATEGORY_SLUGS,
    is_meal_category_slug,
)
from gourmet.adapter.outbound.orm.daily_recommendation import DailyRecommendation
from gourmet.adapter.outbound.orm.meal_plan import MealPlan
...
from gourmet.adapter.outbound.pg.restaurant_orm_loads import RESTAURANT_CARD_LOADS
