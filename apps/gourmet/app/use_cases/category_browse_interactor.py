...
from gourmet.data.category_topics import filter_topics_by_query, topics_for_category
...
def _pool_for_category_slug(db: Session, category_slug: str) -> list[RestaurantBrowseRow]:
    ...
    from gourmet.app.use_cases.restaurant_browse_interactor import count_restaurants
