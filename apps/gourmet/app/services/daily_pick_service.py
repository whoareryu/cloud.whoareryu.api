...
from apps.gourmet.app.data.ingestion.category_normalizer import (
    NON_MEAL_CATEGORY_SLUGS,
    is_meal_category_slug,
)
from apps.gourmet.app.models.daily_recommendation import DailyRecommendation
...
def get_daily_pick(
    ...
    *,
    ...
    if user_id is not None:
        meal_plan = MealPlanRepository().get_active_for_user(db, user_id, today)
