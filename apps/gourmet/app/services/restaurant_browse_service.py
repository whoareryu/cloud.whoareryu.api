...
from apps.gourmet.app.data.category_catalog import CATEGORY_LABEL_BY_SLUG
from apps.gourmet.app.data.ingestion.category_normalizer import classify_sgma_category
