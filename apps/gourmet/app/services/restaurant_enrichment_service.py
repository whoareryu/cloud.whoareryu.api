...
from apps.gourmet.app.adapters.kakao_local_client import lookup_place as kakao_lookup
from apps.gourmet.app.adapters.localdata_client import lookup_store as localdata_lookup
from apps.gourmet.app.config.external_settings import get_external_settings
