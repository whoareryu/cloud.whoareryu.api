...
class JamesDirectorRepository(JamesDirectorPort):
    ...
    async def receive_uploaded_records(
        ...
        from titanic.adapter.outbound.orm.passenger_rose_model_strategies import RoseModelORM  # noqa: PLC0415
    ...
    async def introduce_myself(self, schema: JamesDirectorQuery) -> JamesDirectorResponse:
        return JamesDirectorResponse(answer=f"id={schema.id * 10000}, name={schema.name}")
